...
const Hero = () => (
  ...
  <div
    ...
    <img
      ...
      `}
      src="/static/gishohaku11-logo.png"
      width={280}
      height={280}
    />
    <div
      ...
      <div
        ...
        `}>
        2025.01.25 <small>Sat. 11:00~16:00</small>
      </div>
      <div
        css={css`
          font-size: 20px;
        ...
        <TextBlock>
          ...
          <div
            ...
            <p css={withIcon}>
              ...
              神奈川県横浜市中区山下町2（
              <a target="_blank" href="https://maps.app.goo.gl/SHzEres3KaXEjDq57">
                Google マップ
              </a>
              ）
            </p>
