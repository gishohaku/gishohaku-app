...
const SEO: React.FC<Props> = ({ description, title, imageUrl }) => {
  ...
  const jsonLdTags = {
    ...
    endDate: '2022-11-20',
    image: 'https://gishohaku.dev/static/gishohaku7-ogp.png',
  ...
  return (
    <Head>
      ...
      <link
        rel="icon shortcut"
        sizes="256x256"
        href={'https://gishohaku.dev/static/gishohaku7-icon.png'}
        type="image/png"
      />
      <link
      ...
      <meta
        property="favicon"
        content={'https://gishohaku.dev/static/gishohaku7-icon.png'}
        key="image"
      />
      <meta
      ...
      <meta
        property="og:image"
        content={imageUrl || 'https://gishohaku.dev/static/gishohaku7-ogp.png'}
        key="image"
      />
      <meta
        name="twitter:card"
