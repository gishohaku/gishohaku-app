...
const SEO: React.FC<Props> = ({ description, title, imageUrl }) => {
  ...
  const jsonLdTags = {
    ...
    endDate: '2025-10-26',
    image: 'https://gishohaku.dev/static/gishohaku12-ogp.png',
    ...
    location: {
      ...
      address: {
        '@type': 'PostalAddress',
        addressLocality: '埼玉県さいたま市大宮区',
        addressRegion: 'JP',
        postalCode: '330-8669',
        streetAddress: '埼玉県さいたま市大宮区桜木町1-7-5',
      },
    },
  }
  ...
  return (
    <Head>
      ...
      <link
        rel="icon shortcut"
        sizes="256x256"
        href={'https://gishohaku.dev/static/gishohaku12-icon.png'}
        type="image/png"
      />
      <link
      ...
      <meta
        property="favicon"
        content={'https://gishohaku.dev/static/gishohaku12-icon.png'}
        key="image"
      />
      <meta
      ...
      <meta
        property="og:image"
        content={imageUrl || 'https://gishohaku.dev/static/gishohaku12-ogp.png'}
        key="image"
      />
      <meta
        name="twitter:card"
