...
const gishohaku9Circles = [
  { id: 'jJsopzo5HTdqZj9VJTOl', name: '統計の森', booth: 'あ-1' },
  { id: 'kM4KEOGxsded14H5Fx8U', name: 'じゅ～しぃ～すくりぷと', booth: 'あ-2' },
  { id: 'UNNTsw39dBzAn5cGGxOg', name: 'にゃむねこ', booth: 'あ-3' },
  { id: 'OZsJPYFaMKN4sp0CZRYW', name: 'Mathematica研究会葛飾支部', booth: 'あ-4' },
  { id: 'fZM9r26YHsPUfK8PTsFH', name: 'URAMASU', booth: 'あ-5' },
  { id: 'OeTQYlGZDwWPivgtR3QG', name: 'ゆめみ大技林製作委員会', booth: 'あ-6' },
  { id: 'gNGhd9TVc7yK3yQI76G4', name: 'CloudFormationの友', booth: 'あ-7' },
  { id: 'xFI7Rzg8vpMqEp6Gs8BL', name: 'ビルド工房', booth: 'あ-8' },
  { id: 'UKKrHYUbp7TD3m3vgrUY', name: 'RichLab. & 第7開発sec.', booth: 'あ-9' },
  { id: '5ADgAbPCwfHXZxn2073p', name: 'tenteroring project', booth: 'い-1' },
  { id: '0Tzpf6g5fTBUr189wYAx', name: 'もちっとカフェ', booth: 'い-2' },
  { id: 'FWhRfNBt9k6Bl5kQ8r1j', name: 'まぐろのみぞおち', booth: 'い-3' },
  { id: 'sp9WfOob1UsmOImQs3DX', name: '人生適当', booth: 'い-4' },
  { id: 'eUGHGKq0Se8rB5kTcgCj', name: 'OHK', booth: 'い-5' },
  { id: 'jeXEUv9dVo9Ah7IHdmNe', name: 'ねこはうす', booth: 'い-6' },
  { id: 'EWpZyp36v86cQRppsWni', name: 'めもおきば', booth: 'い-7' },
  { id: 'gUFl77e61sOgt00M2Zds', name: '愛知工業大学　システム工学研究会', booth: 'い-8' },
  { id: 'TOzmoGVCeb3SyK0a4x94', name: 'SouthernParadise', booth: 'い-9' },
  ...
  { id: 'EMplk8DcsYtXmgjGzJ8L', name: '楽しい工学生活を送る会', booth: 'う-1' },
  { id: 'chO2CfVVFcOQfZx9xeur', name: '音引屋', booth: 'う-2' },
  { id: 'J6cCqEpnIHHzg7edQlyb', name: 'Thunder Claw', booth: 'う-3' },
  { id: 'JZWuUGoo4hE1PcGEyRLP', name: '香美山社中', booth: 'う-4' },
  { id: 'PAqhwXhb3FKKzQ0f5P5J', name: 'megusunuLab', booth: 'う-5' },
  { id: 'YNExajTtSC1s9uImrqA2', name: '象形科技', booth: 'う-6' },
  { id: 'BRRMCrE5s6m19yLrcB6T', name: 'さかさまダイアリー', booth: 'う-7' },
  { id: 'EtsgseXy5jiRa5zRJK8c', name: '黒猫舎', booth: 'う-8' },
  { id: 'xigISD6nQPWYN9jDJvg6', name: 'Just1factory', booth: 'う-9' },
  ...
  { id: 'J5XxlRPPY3YKcIABxyp3', name: 'TeamJ', booth: 'え-1' },
  { id: '9taEdI8U2zuUUhuicX7o', name: 'Auth屋', booth: 'え-2' },
  { id: 'x5Na8P3OwcXgts6WowoJ', name: 'テスターちゃん', booth: 'え-3' },
  { id: 'SLL887w9AjrTtGZaqSmE', name: 'きじのしっぽ', booth: 'え-4' },
  { id: '5jl7V3RZP29eVZPJCikT', name: '増井技術士事務所', booth: 'え-5' },
  { id: 'Qf9aFKEtEEUJ2rgriXc2', name: 'C.9', booth: 'え-6' },
  { id: 'tZneGBAoK15IzvKk32wF', name: 'Aurantifolia', booth: 'え-7' },
  { id: 'Ei7AablrwYm7V6G5BFM8', name: 'つのぶえ出版', booth: 'え-8' },
  { id: 'vP6b81mdzEkDDzWah0fD', name: '品質公団', booth: 'え-9' },
  ...
  { id: 'XgzG6SF692GOtUL4tY3m', name: 'ある世界', booth: 'お-1' },
  { id: 'DDyFcUIqs1XsUESCshOH', name: '親方Project', booth: 'お-2' },
  { id: '2DiUt26a7NH3Qrvv3hPr', name: 'あじゃてく', booth: 'お-3' },
  { id: 'fjeNcx3OIqoy31Gb1WTJ', name: '特定非営利活動法人 NEM技術普及推進会 NEMTUS', booth: 'お-4' },
  { id: 'qt3jxgwOQ9XLrguxP2g1', name: 'Computer Society', booth: 'お-5' },
  { id: 'Sgt2kV1OrOFwoNdliLyD', name: 'Project Kit', booth: 'お-6' },
  { id: 'R9ApaXyDJmGgi1S3PSMf', name: 'Kiryushiki Project.', booth: 'お-7' },
  { id: 'OGNiNG4MJ3AJ4CfrPKww', name: 'しまや出版', booth: 'お-8' },
  { id: 'kRjDo4jOaOf6kRNV9xjc', name: 'システムアイ', booth: 'お-9' },
  ...
  { id: 'RcWQBehDovnBOMlE08Qu', name: '株式会社ボーンデジタル', booth: 'か-1' },
  { id: 'TTwWcNb1KCXE1HNljQLY', name: 'マイナビ出版編集部', booth: 'か-2' },
  { id: '4MYHhb6UHkiDngPSXeZ5', name: '講談社サイエンティフィク', booth: 'か-3' },
  { id: 'A9s4qIxziM91hJEPkM8C', name: 'I/O技書博部', booth: 'か-4' },
  { id: 'sFrSEQnEv40zsUypQseH', name: 'とうきょうかがく同人', booth: 'か-5' },
  { id: 'qb0jQUIaa3X0xMRXwmQ6', name: '技術評論社', booth: 'き-1' },
  { id: 'YktBg5dsDbpGaRREERVN', name: '翔泳社', booth: 'き-2' },
  { id: 't2fGj7PJSfgYnzaFRZah', name: 'ソシム', booth: 'き-4' },
  { id: 'Vp9B4glPdRC47LjJivXb', name: 'お台場計算尺', booth: 'く-1' },
  { id: 'JG8wLt3CX9IQFWlw7Usv', name: 'いもあらい。', booth: 'く-2' },
  { id: 'zkabLB2tJzYphx8RZ76A', name: 'たいら屋', booth: 'く-3' },
  { id: 'VCV3xgHSfAbcFEAtyqVo', name: 'ちんちらんど', booth: 'く-4' },
  { id: 'pC8iLGJyZYylsmohOflc', name: '誤家庭工房', booth: 'く-5' },
  { id: 'UcpeUTfaxK2HCRkCqYca', name: 'tecalac', booth: 'く-6' },
  { id: 'u0TLFbr2AwhEpvYbHFkr', name: '徒然メカ', booth: 'く-7' },
  { id: 'YonxU1CcVcTdBdphMr5H', name: 'けもみみまほーつかい', booth: 'く-8' },
  { id: 'gAFSqQISzyo9lCjJ4I6m', name: 'ZOB.Club', booth: 'け-1' },
  { id: 'YA9oHpMyP7Awp2Mbtuh6', name: 'オレンジピコショップ', booth: 'け-2' },
  { id: 'zennqr8SA0Rz7u3FKT7w', name: 'しょ〜とらば〜ず', booth: 'け-3' },
  { id: 'vQiVPNp1T07RoOVrzFsd', name: '三峰スズ工房', booth: 'け-4' },
  { id: 'VZcJ3lxe7Cfd0MaRx6TI', name: 'エンジニアの登壇を応援する会', booth: 'け-5' },
  { id: 'UP95fKF0ufKk07TDa3zp', name: 'ZINE Community', booth: 'け-6' },
  { id: 'pf98ZrXLGQKluHdAXQg7', name: 'Vivliostyleユーザー会', booth: 'け-7' },
  { id: 'lN3SkneROHjUUGLLWC7M', name: 'きのこるエフエム', booth: 'け-8' },
  { id: 'bElZBHESGaRCWnr4YGjm', name: 'ＣＱ出版社', booth: 'こ-1' },
  { id: '439J8xSRrAzmWZ3Pfxd2', name: 'ノラハック', booth: 'こ-2' },
  { id: 'qhbbBkBcmxGxo5OfuXRr', name: 'ふがふが', booth: 'こ-3' },
  { id: '4gl0bQN1BAumiYGyKXsC', name: 'PikoPikoFactory', booth: 'こ-4' },
  { id: '1km4u8z5uSjI1mxC2dAa', name: 'FREES', booth: 'こ-5' },
  { id: 'xoLp5SKrRF5v7HE3EOqn', name: 'へにゃぺんて', booth: 'こ-6' },
  { id: '3bMzzDUFBBKQAIWSN2JX', name: '植物生体電位をオープンにするプロジェクト', booth: 'こ-7' },
  { id: '0nuHxWJgLA7tfb1zSof5', name: 'holiday lab.', booth: 'こ-8' },
  { id: 'wkq1tnt3Zv3qZwk0kBwg', name: '自転車操業', booth: 'さ-1' },
  { id: '3Z7BRs2FOBrSR2Tg7bzG', name: 'とこしえ工房', booth: 'さ-2' },
  { id: 'GS71rK6j0XFO98CnQZrv', name: '野狐ヲ俱楽部', booth: 'さ-3' },
  { id: '6kNHn2jVGzX7nKF3JcQM', name: '秋葉原無線部', booth: 'さ-4' },
  { id: 'pBWcfdcEa7M4XbHApJkA', name: 'PUNDI X', booth: 'さ-5' },
  { id: 'ZdqXXlJ9RgY6zHt6hthH', name: 'Low Technology Laboratory', booth: 'さ-6' },
  { id: 'e5H5VLnX3NEaoalkPDGa', name: '鉄道同人技術研究所', booth: 'さ-7' },
  { id: 'OduECrBMIgFkFL6iHCZC', name: 'nano-Lab.', booth: 'し-1' },
  { id: 'JFKEsySZoy3MyyIc9Lki', name: '味噌とんトロ定食', booth: 'し-2' },
  { id: 'kjFguGX4Klre93AY1y0t', name: 'フトンカブーレ', booth: 'し-3' },
  { id: 'a9nCkCq1HRe9U6HjbmoX', name: 'モウフカブール', booth: 'し-4' },
  { id: 'a07K1W4t62R2zxmeV9dh', name: 'AliceSystem', booth: 'し-5a' },
  { id: 'H9iNGRQ6wQ3RHqLmhGft', name: '共鳴効果', booth: 'し-5b' },
  { id: 'Mi1uJIb9QmRejFOUpdML', name: 'ブライトシステム', booth: 'し-6' },
  { id: 'ATlAF2d5XR7u5p5xshaJ', name: '村山直紀', booth: 'し-7' },
  { id: 'QfX0AMAlNMHoFGDLcz5H', name: 'エンジニアカウンセラー', booth: 'し-8' },
]
