...
const gishohaku11Circles = [
  { id: 'FiJarnpGFssshY7S2Paz', name: 'ふがふが', booth: 'あ-01' },
  { id: 'f2xDlBW1tCVnpa7KbzqC', name: 'ノラハック', booth: 'あ-02' },
  { id: 'Kcshza966Q4nO6lnxKZ5', name: 'しょ〜とらば〜ず', booth: 'あ-03' },
  { id: 'I2jTlhtEHbwm733ou883', name: 'tecalac', booth: 'あ-04' },
  { id: 'VW4IiTfJLpKUN3XFYOan', name: 'XianDIY', booth: 'あ-05' },
  { id: 'UGaGTbBnJL78IOHyp7om', name: 'きじのしっぽ', booth: 'あ-06' },
  { id: 'q5Tayxk1Dx6AVa0JVVeR', name: 'けもみみまほーつかい', booth: 'あ-07' },
  { id: '4TdtoGbrIRPzg7ebATAS', name: 'FOSS4GファンクラブfromOSGeo.JP', booth: 'あ-08' },
  { id: 'rZfRre44gCZ8KdaPM64T', name: '株式会社しまや出版', booth: 'あ-09' },
  { id: 'KFT7gUhR47NhsGlZkczi', name: 'I/O技書博部', booth: 'あ-10' },
  { id: 's79yBpEW5CBOAdN0aTO6', name: '株式会社コロナ社', booth: 'あ-11' },
  { id: 'bL2wAKAW2TARgxQlmALw', name: '株式会社技術評論社', booth: 'あ-12' },
  { id: 't88hiSJ9HYLi3Z8etHsy', name: 'ZOB.Club', booth: 'い-02' },
  { id: '3QahcWr8puWztyiT2Ntj', name: '味噌とんトロ定食', booth: 'い-03' },
  { id: 'ualqXzrX95L2wkYn71J6', name: 'ビットキー技術書部', booth: 'い-04' },
  { id: 'TMelE0GjqQbJjYdr7P28', name: '株式会社プレーンテキスト', booth: 'い-05' },
  { id: 'O6vKwaWW19Ttw3BzUtCc', name: 'ダウンロードラボラトリ', booth: 'い-06' },
  { id: 'HzO2MemZAuJNC9FjjAdl', name: 'Just1factory', booth: 'い-07' },
  { id: 'XGLc7KvUqbW8z7k3bKqw', name: 'ゆめみ大技林製作委員会', booth: 'い-08' },
  { id: 'xYO6YpyxFr0eLiibTp1R', name: 'ある世界', booth: 'い-09' },
  { id: 'hiMitpXO9vWqVoayLmbd', name: '親方Project', booth: 'い-10' },
  { id: 'EFrElqlpwEKMjmjluMZK', name: '未来機械工房', booth: 'う-01' },
  { id: 'jxB8qkXWfLwdw0s2dg3x', name: 'URAMASU', booth: 'う-02' },
  { id: 'jrpH1Jv7mC3DBPvjRwLK', name: 'Sagittarius_Chiron', booth: 'う-03' },
  { id: 'wj6KPo94NbIC1R6JaU1y', name: 'FROMCRADLETOGRAVE', booth: 'う-04' },
  { id: 'mrxGrYhC34bixCQ0Prap', name: '波耶書房', booth: 'う-05' },
  { id: 'i6NT1HgO5r5Lz3P51snA', name: '徒然メカ', booth: 'う-06' },
  { id: 'JpMRj6SYkyX1iH9Ebyej', name: 'RyomaLab', booth: 'う-07' },
  { id: 'AKEcFEaqGITC8212RqED', name: 'トライアル・ラン', booth: 'う-08' },
  { id: 'wGEjsOWgBhDWYZBHWPKf', name: 'nano-Lab.', booth: 'う-09' },
  { id: 'LgLsZzRFSCgNn0wSwt0t', name: '共鳴効果', booth: 'う-10' },
  { id: 'OTSyV7dlF1Cw52wJrWtr', name: 'モウフカブール', booth: 'う-11' },
  { id: 'p1vbn4Q7iXaUd5iMUq4L', name: 'フトンカブーレ', booth: 'う-12' },
  { id: 'GcXqSWYQT077xHSRgXM5', name: 'ブライトシステム', booth: 'う-13' },
  { id: 'ge3CWJSaBWz71pPFMryB', name: '一般社団法人電波教育協会', booth: 'え-01' },
  { id: 'cLw5Hke0VMWKbbK27ZoN', name: 'LowTechnologyLaboratory', booth: 'え-02' },
  { id: '86Qi9YLmJIAjbr1FODCI', name: 'tenteroringproject', booth: 'え-03' },
  { id: 'gunfJ0X76SDyPdGRtzu9', name: 'D.MEntryPoint', booth: 'え-04' },
  { id: 'Ups2TgrELdCOnGaIUpmv', name: 'PieceofTechnology', booth: 'え-06' },
  { id: 'z7N2cWTqM9PvkiH0uInz', name: 'OtakuAssembly', booth: 'え-07' },
  { id: 'Unh4p0vuGgMCXvKEgpWk', name: 'へにゃぺんて', booth: 'え-08' },
  { id: '5Ve0FcoD5uyJryhzHoUN', name: 'さくらインターネット株式会社', booth: 'お-01' },
  { id: 'sugWMd6Gy4HevGQ9tUyi', name: 'テクノブレーン株式会社', booth: 'お-03' },
  { id: 'huDqaqAqBMSiPsA7NL9N', name: 'ソシム株式会社', booth: 'お-05' },
  { id: 'oFwHeDj7bBgJ7XanEOj3', name: '株式会社システムアイ', booth: 'お-07' },
  { id: 'v1Rj1jpHuQCaSieEuFpJ', name: '株式会社秀和システム', booth: 'か-01' },
  { id: '4oXFUQZaGdLlWccqB4jS', name: '楽しい工学生活を送る会', booth: 'か-02' },
  { id: 'BPUXNWhKTq6QaYGCz9im', name: 'Mathematica研究会', booth: 'か-03' },
  { id: '35n1gq8zYJVgX1pTzcKc', name: 'TypeD4Lab', booth: 'か-04' },
  { id: 'DM6gAylqFZTuVdMrP5jB', name: 'たいら屋', booth: 'か-05' },
  { id: 'lwl9wwsr4IbDZo0qWh3F', name: 'ちんちらんど', booth: 'か-06' },
  { id: 'nsRhjtaORw2xPQ60jrDk', name: 'おとしぶみ', booth: 'か-07' },
  { id: 'ymc6S6apqmcAl2BGlC5Z', name: '画像野郎', booth: 'か-08' },
  { id: 'jUGWfooEVCwpUdZnWFle', name: 'SouthernParadise', booth: 'か-09' },
  { id: 'V4dPI6h5TuIpebb6GdxU', name: 'PlatformEngineeringMeetup', booth: 'か-10' },
  { id: 'f650ziFjvgK75m19Pkr6', name: 'Luciano研究所(旧システム工学研究会)', booth: 'か-11' },
  { id: 'IvqtzH6AtY3vh3G1uomi', name: 'おとうふ工房', booth: 'か-12' },
  { id: 'qxTtymhe7iAVBGjX07lL', name: 'Raven\'snest', booth: 'か-13' },
  { id: 'z6s5tVRL4KnRLK4X5fCV', name: '日本openSUSEユーザ会', booth: 'き-01' },
  { id: 'LOmokXEikphsDCEG9OEb', name: 'FediverseLinuxUsersGroup', booth: 'き-02' },
  { id: 'JyjiB52Z9qOSm4grRFSQ', name: 'てんぐ屋', booth: 'き-03' },
  { id: 'ThmvoKY30Qg4yLl8GPyr', name: 'めもおきば', booth: 'き-04' },
  { id: 'yVJUjUUlMfgVOYKi54f2', name: 'ねこはうす', booth: 'き-05' },
  { id: 'TR9bYp44pjrM94xG2GqU', name: 'Hyalinios', booth: 'き-06' },
  { id: 'jxt9dtFZ01PzjL1ibpID', name: 'RichLab.&第7開発sec.', booth: 'き-08' },
  { id: 'S1nQpoIFKx5dhJw3Tj9V', name: 'GMOインターネットグループエンジニア有志一同', booth: 'き-09' },
  { id: 'foms5VIRHyffrAi1tjki', name: '雑貨屋かさい', booth: 'き-10' },
  { id: 'lKAs5HXGejPn5Wau5SE9', name: 'まぐろのみぞおち', booth: 'き-11' },
  { id: 'pUPv7Kt3rzW5htl5pXmN', name: 'おのせい', booth: 'く-01' },
  { id: 'AuH19ZPzfoO1eP3diovN', name: 'RabbitSoftWorker\'s', booth: 'く-02' },
  { id: 'oVq3QUDnmxmX1T4s36eq', name: 'KLab株式会社', booth: 'く-03' },
  { id: 'H6xAFeS07UrK2qX4tRkO', name: 'おうちクラウド研究部', booth: 'く-04' },
  { id: 'njPhIpwlFle7i36WdSrP', name: '調布ヶ丘麦作研究農園', booth: 'く-05' },
  { id: 'd4J2rYGx5fQYL3fchtFj', name: '脆弱性診断研究会', booth: 'く-06' },
  { id: 'VfkXv9Iov3HI0xZ4zpfN', name: 'FREES', booth: 'く-07' },
  { id: 'Kff8LlT5q89tXhujUF6Q', name: 'のみぞーん', booth: 'く-08' },
  { id: 'IzDOK9P0a9HiTvifqO4l', name: 'Auth屋', booth: 'く-09' },
  { id: 'TqH6Zsw6KKpjwwJHnxwV', name: 'アウトサイダー', booth: 'く-10' },
  { id: 'CMye7AIZu16Q45K3e1CK', name: '電脳世界', booth: 'く-11' },
  { id: 'dfZ6lzq2C2c61nUcYHUA', name: 'EverlastingDiary', booth: 'く-12' },
  { id: 'RdDirSVIMqvJOrbE95WZ', name: 'もえじら組', booth: 'く-13' },
  { id: 'KZiOs8eAKvI6FNKHIAdJ', name: 'C.9', booth: 'け-01' },
  { id: 'VQL7FtB6sUAbTOd9MAVB', name: 'aozoraProject', booth: 'け-02' },
  { id: '0cyBcvqwEdde7ZKYfaLt', name: 'TeamJ', booth: 'け-03' },
  { id: 'RgJbeTP8Qiy0AL5KhnYo', name: 'Neln', booth: 'け-04' },
  { id: 'PQApoWlyi7Ki9XoDztOq', name: '株式会社ソフトウェアコントロール', booth: 'こ-01' },
  { id: 'ABhUi5ow3U5yqAhxghgA', name: '特定非営利活動法人NEM技術普及推進会NEMTUS', booth: 'こ-02' },
  { id: 'EOtdVtXqq3AwBMDy7w4O', name: 'スタジオfkuMnkStudio', booth: 'こ-04' },
  { id: '6aJ5x2yB69Sa3jdAXrSF', name: '音引屋', booth: 'こ-05' },
  { id: 'msLe4s7DAD2mVREjs8fI', name: 'megusunuLab', booth: 'こ-06' },
  { id: '1FY5MqrJGrl9lU8ENBtc', name: '黒猫舎', booth: 'こ-07' },
  { id: '73RcWsGQsYG7YPBE2UYc', name: 'kanata', booth: 'こ-08' },
  { id: 'IfYxCtB2XQ5XdkpB3QCE', name: 'まことのこと研究所', booth: 'さ-01' },
  { id: 'CrBqLzdJ5L91F1kFukFb', name: '品質公団', booth: 'さ-02' },
  { id: 'rlKl8oYrXWIeoRYgwiyo', name: 'テスターちゃん', booth: 'さ-03' },
  { id: 'mCIgBygmRV8AxZ8YaMZ1', name: 'シスエンモンスター', booth: 'さ-04' },
  { id: 'ZADn6ZjL2phDJmjGi6nx', name: 'エンジニア集会', booth: 'し-01' },
  { id: 'okDWqJQb6KuEMMzTnpwu', name: 'エンジニアカウンセラー', booth: 'し-02' },
  { id: 'bH3CsZ7bLjUthNUTRh7z', name: 'ノンプログラマーのためのスキルアップ研究会', booth: 'し-03' },
  { id: 'uL1G46Kq8aB1qlBCYvL4', name: 'ZINECommunity', booth: 'し-04' },
  { id: '2YC2sf5U1AiR33EeCwWx', name: 'はなごよみ', booth: 'し-05' },
]
