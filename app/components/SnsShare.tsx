...
export enum SnsShareSize { Small, Large }
...
const SnsShare: React.SFC<Props> = (props) => {
  ...
  `}>
      ...
      <a
        ...
        data-show-count="false">Twitterで共有</a>
      ...
      <div
        ...
        <a
          target="_blank"
          href={'https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(currentUrl)+'&amp;src=sdkpreparse'}
      ...
      <a
        ...
        data-hatena-bookmark-height={(props.size == SnsShareSize.Small) ? "20" : "28"}
        data-hatena-bookmark-width={(props.size == SnsShareSize.Small) ? "95" : "100"}
